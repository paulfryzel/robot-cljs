...
var robot = {core:{}};
robot.core.main = function() {
  return null;
};
cljs.core._STAR_main_cli_fn_STAR_ = robot.core.main;
robot.core.Robot = function() {
};
robot.core.Robot.cljs$lang$type = !0;
robot.core.Robot.cljs$lang$ctorStr = "robot.core/Robot";
robot.core.Robot.cljs$lang$ctorPrWriter = function(a, b, c) {
  return cljs.core._write.call(null, b, "robot.core/Robot");
};
robot.core.Robot.prototype.speak = function() {
  return "beep boop";
};
robot.core.__GT_Robot = function() {
  return new robot.core.Robot;
};
module.exports = robot.core.Robot;
cljs.nodejs = {};
